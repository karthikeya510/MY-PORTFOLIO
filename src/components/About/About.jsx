      ...
      <div className={styles.content}>
        ...
        <div className={styles.skills}>
          ...
          <div className={styles.skillItem} ref={addToRefs}>
            ...
            <div className={`${styles.skillText} skill-text`}>
              <h3>Video Editor</h3>
              <p>Skilled in creating engaging and polished videos using professional editing software like Adobe Premiere Pro and After Effects. Expert at storytelling through video, adding effects, and color grading to make videos stand out.
